...
const ScholarshipPage = () => {
  // Course filter removed — programs (diploma, undergraduate, masters, PhD)
  // are now displayed on the dedicated page: /golearn-courses
  ...
  const services = [
    {
      ...
      description:
        "Matching your goals, strengths, and interests with countries, universities, and programs. Popular destinations: India, China, Malaysia, Turkey.",
    },
    {
      icon: <FileText className="h-8 w-8 text-emerald-600" />,
      title: "University Admissions Assistance",
      description:
        "Shortlisting universities, preparing documents, tracking deadlines, SOP/LOR writing & editing, application form filling, document verification, timely submission follow-up.",
    },
    {
      icon: <Globe className="h-8 w-8 text-amber-600" />,
      title: "Visa Guidance & Processing",
      description:
        "Expertise in visa processes, complete support for visa success rate, visa interview preparation, financial documentation support, statement of purpose review, real-time updates and application monitoring.",
    },
    {
      icon: <Award className="h-8 w-8 text-green-600" />,
      title: "Scholarships & Financial Aid (Up to 100%)",
      description:
        "We help you apply for partial (50%) to full (100%) scholarships, based on merit, need, or country-specific criteria.",
    },
    {
      icon: <Plane className="h-8 w-8 text-indigo-600" />,
      title: "Pre-Departure & Post-Arrival Support",
      description:
        "Help with settling in and succeeding, cultural orientation & student life briefing, packing, travel, and insurance advice, accommodation booking, airport pickup assistance, local emergency contact support.",
    },
  ];
  ...
  // Course listings were moved to a dedicated page: /golearn-courses
  // All course-related arrays and filtering were removed from this overview page.
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div
            className={`absolute inset-0 bg-cover bg-center transition-all duration-1000 bg-[url('${backgroundImages[currentImageIndex].url}')]`}
          />
          {/* Gradient Overlay */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center relative z-10">
            ...
            >
              ...
              is your trusted partner in turning that dream into success. We
              believe{" "}
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-extrabold text-center mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-amber-500 to-emerald-600">
              What is GoLearn Global?
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed text-center max-w-4xl mx-auto">
              ...
              <span className="text-amber-700 font-semibold">
                academic opportunities worldwide
              </span>
              . We guide you through every step of your{" "}
              <span className="text-blue-700 font-semibold">
                study abroad journey
              </span>
              —from choosing the right course to securing{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-amber-500 to-emerald-600 mb-1">
                  {stat.number}
                </div>
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-700 max-w-2xl mx-auto">
            To browse all GoLearn Global programs (Diploma, Undergraduate,
            Masters, PhD) please visit the
            <Link
              to="/golearn-courses"
              className="text-emerald-600 font-semibold ml-1"
            >
              {" "}
              GoLearn Programs page
            </Link>
            .
          </p>
        </div>
      ...
      {/* Course listings removed from this overview. */}
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link
            to="/golearn-courses"
            className="inline-block px-6 py-3 rounded-lg bg-gradient-to-r from-blue-600 via-amber-500 to-emerald-600 text-white font-semibold shadow-lg"
          >
            View GoLearn Global Programs
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-amber-500 to-emerald-600">
              Types of Scholarships We Assist With
            </h2>
            <p className="text-gray-700 max-w-2xl mx-auto mb-8">
              <span className="text-blue-700 font-semibold">
                Studying abroad
              </span>{" "}
              doesn't have to break the bank. We help you apply for{" "}
              <span className="text-emerald-700 font-semibold">
                partial (50%) to full (100%) scholarships
              </span>
              , based on{" "}
              <span className="text-amber-700 font-semibold">
                merit, need, or country-specific criteria
              </span>
              .
            </p>
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="mt-8 p-4 bg-emerald-100 rounded-lg">
                <p className="text-emerald-900 font-semibold text-center">
                  "Several of our students have secured{" "}
                  <span className="text-amber-800">
                    scholarships covering up to 100% of tuition
                  </span>
                  , saving{" "}
                  <span className="text-blue-800">thousands of dollars</span>{" "}
                  while gaining a{" "}
                  <span className="text-green-800">world-class education</span>
                  ."
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-amber-500 to-emerald-600">
              What We Offer: End-to-End Support
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-amber-600 to-emerald-700 mb-2">
                  {service.title}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-700 max-w-2xl mx-auto mb-8 text-lg">
              Our experienced counselors and specialists are here to guide you
              every step of the way on your
              <span className="text-blue-700 font-semibold">
                {" "}
      ...
      <section className="py-16 text-white relative bg-gradient-to-r from-blue-700 via-amber-600 to-emerald-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-amber-100 to-emerald-200">
              Ready to Start Your Journey?
            </h2>
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">
              Contact us today to begin your path to{" "}
