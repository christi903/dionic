          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-blue-600 hover:text-blue-700 text-xs font-medium px-3 py-1 rounded-full border border-blue-200 hover:border-blue-300 transition-colors duration-200"
              >
