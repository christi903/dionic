                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                    <button
                      ...
                      type="button"
                      aria-label={`View application ${application.id} for ${application.full_name}`}
                      title={`View application ${application.id}`}
                    ...
                    <button
                      ...
                      type="button"
                      aria-label={`Delete application ${application.id} for ${application.full_name}`}
