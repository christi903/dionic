        ...
        <div className="border-t p-5 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              value={customQty}
              onChange={(e) =>
                setCustomQty(Math.max(1, Number(e.target.value) || 1))
              }
              className="w-20 px-3 py-2 border rounded"
              aria-label="Custom item quantity"
              title="Custom item quantity"
              placeholder="Qty"
            />
            <button
              onClick={() => {
                if (customName.trim()) {
                  onAddCustom(customName.trim(), customQty);
                  setCustomName("");
                  setCustomQty(1);
                }
              }}
          ...
          <button
            ...
            className="w-full px-4 py-3 rounded bg-green-600 hover:bg-green-700 text-white font-medium flex items-center justify-center gap-2"
          >
